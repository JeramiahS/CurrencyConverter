This CLI tool utilizes FXRatesAPI's API to allow the user to convert a monetary value from one currency into 175+ other currencies including cryptocurrencies.
